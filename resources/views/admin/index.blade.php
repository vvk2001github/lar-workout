                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="{{ 'dropdownMenuButton1'.$user->id }}">
                                    <li><a id="{{ 'setPassUser'.$user->id }}" data-id="{{ $user->id }}" data-username="{{ $user->name }}" class="dropdown-item" href="#"><i class="bi bi-gear"></i>&nbsp;Reset pass</a></li>
                                    <li><hr class="dropdown-divider"></li>
                                    <li><a id="{{ 'deleteUser'.$user->id }}" data-id="{{ $user->id }}" data-username="{{ $user->name }}" class="dropdown-item" href="#"><i class="bi bi-x-square"></i>&nbsp;Delete</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
