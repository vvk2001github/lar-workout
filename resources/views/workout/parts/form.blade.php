...
<div class="mb-2">
    ...
    <input name="count1" required  type="text" class="form-control" id="count1" aria-describedby="count1_help" value="{{ old('count1') ?? $workout->count1 ?? ''}}">
...
<div class="mb-2" id="divWeight1">
    ...
    <input name="weight1" required  type="text" class="form-control" id="weight1" aria-describedby="weight1_help" value="{{ old('weight1') ?? $workout->weight1 ?? ''}}">
...
<div class="mb-2" id="divCount2">
    ...
    <input name="count2" required  type="text" class="form-control" id="count2" aria-describedby="count2_help" value="{{ old('count2') ?? $workout->count2 ?? ''}}">
...
<div class="mb-2" id="divWeight2">
    ...
    <input name="weight2" required  type="text" class="form-control" id="weight2" aria-describedby="weight2_help" value="{{ old('weight2') ?? $workout->weight2 ?? ''}}">
